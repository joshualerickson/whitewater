...
knitr::opts_chunk$set(
  collapse = TRUE,
  comment = "#>",
  dev.args = list(png = list(type = "cairo")), fig.align='center', fig.height=6, fig.width=8
)
library(dplyr)
dam_ts <- readr::read_csv('C:/Users/joshu/OneDrive/Documents/R/test/playing/dam_ts.csv') 
pnw_wy <- readr::read_csv('C:/Users/joshu/OneDrive/Documents/R/test/playing/pnw_wy.csv')
```
