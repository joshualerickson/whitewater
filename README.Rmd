...
**Please, due to potentially crashing (USGS Water Services)[https://waterservices.usgs.gov/] REST services keep your parallel processing to 10 cores/workers or less. By following this limit, we can still benefit from parallel processing but also being mindful/respectful to the USGS Water Services via [{dataRetrieval}](https://github.com/USGS-R/dataRetrieval) and REST services. Thank you!**    
