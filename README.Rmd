...
(p2|p1 + theme(legend.position = 'bottom', legend.margin = margin(l = -10, unit='cm'))) +
  plot_annotation(title = 'Mann-Kendall trend analysis (Peak Flow) with active USGS sites in Region 17', subtitle =  '10 years or more of data')
 ...
 pnw_wy %>% 
  ...
  facet_wrap(~cut_q, scales = 'free') + 
   labs(title ='Sites with (p <= 0.05) and slope of linear model as color', 
        color = 'Slope (beta)', y = 'Peak Flows (cfs)',
